...
window.onload = () => {
  ...
  document.getElementById("rangeValue").innerText =
    document.getElementById("viewRange").value;
  switch (tmp.get("number")) {
    case "0":
      document.getElementById("newsTable").style.fontSize = "1em";
      break;
    case "1":
      document.getElementById("newsTable").style.fontSize = "1em";
      break;
    case "2":
      ...
      break;
    case "3":
      document.getElementById("newsTable").style.fontSize = "0.9em";
      break;
    case "4":
      document.getElementById("newsTable").style.fontSize = "0.75em";
      break;
    case "5":
      document.getElementById("newsTable").style.fontSize = "0.6em";
      console.log(document.getElementById("newsTable").style.fontSize);
      break;
  }
  switch (tmp.get("theme")) {
    case "정치":
      document.getElementById("정치").className = "button-theme-clicked";
      break;
    case "경제":
      document.getElementById("경제").className = "button-theme-clicked";
      break;
    case "사회":
      document.getElementById("사회").className = "button-theme-clicked";
      break;
    case "생활":
      document.getElementById("생활").className = "button-theme-clicked";
      break;
    case "IT":
      document.getElementById("IT").className = "button-theme-clicked";
      break;
    case "세계":
      document.getElementById("세계").className = "button-theme-clicked";
      break;
  }
};
/*페이지 이동 버튼 조정하는 함수*/
